...
client.add_event_handler(answer, events.NewMessage(outgoing=True, forwards=False, chats=[-1001633660171]))
client.add_event_handler(answer, events.NewMessage(incoming=True, forwards=False, chats=[-1001633660171]))
