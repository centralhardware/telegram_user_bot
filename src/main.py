...
client.add_event_handler(answer, events.NewMessage(outgoing=True, pattern='!ии', forwards=False))
client.add_event_handler(answer, events.NewMessage(incoming=True, pattern='!ai', forwards=False, chats=[-1001633660171]))
client.add_event_handler(answer, events.NewMessage(incoming=True, pattern='!ии', forwards=False, chats=[-1001633660171]))
