...
from Ai import answerPublic, anserPrivate
...
client.add_event_handler(answerPublic, events.NewMessage(outgoing=True, pattern='!ai', forwards=False))
client.add_event_handler(anserPrivate, events.NewMessage(incoming=True, pattern='!ai', forwards=False, chats=[-1001633660171]))
