...
client2.add_event_handler(answer, events.NewMessage(outgoing=True, forwards=False, chats=[-1002128023267, -1002078316518, -1002225922548, -4262415334]))
client2.add_event_handler(answer, events.NewMessage(incoming=True, forwards=False, chats=[-1002128023267, -1002078316518, -1002225922548, -4262415334]))
